...
# Finding Words Game Script - Fixed Version
# Dynamic hole assignment with mixed letters and proper text wrapping
...
# Available words for holes (mix of common words and other things)
...
# Drag and drop
var dragging_shovel = null
var drag_offset = Vector2()
#var original_positions = {}
var original_position = Vector2()

# UI references
@onready var current_word_label = $UI/CountDisplayPanel/WordsRemaningLabel
...
# Hole references
@onready var hole1 = $"Digging Area"/DigSpot1
@onready var hole2 = $"Digging Area"/DigSpot2
@onready var hole3 = $"Digging Area"/DigSpot3
@onready var hole4 = $"Digging Area"/DigSpot4
...
func _ready():
	print("Finding Words Game - PROTOTYPE VERSION (6 words per level)")
...
func setup_game():
	...
	if not current_word_label or not score_label:
